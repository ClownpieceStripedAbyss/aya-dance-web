...
import { initDB, OPTIONS_NAME } from "@/utils/local";
...
const PlayOptionSlice = createSlice({
  ...
  reducers: {
    ...
    copyPlayOptionsInternal: (state, action: PayloadAction<PlayOptions>) => {
      state.lockedRandomGroup = action.payload.lockedRandomGroup;
    }
  },
...
export const { setLockedRandomGroup, copyPlayOptionsInternal } =
