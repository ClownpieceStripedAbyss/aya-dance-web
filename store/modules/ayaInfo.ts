...
// 选择器fn
export const selectAyaInfo = createSelector(
  (state: RootState) => state.AyaInfo, // 输入选择器
  (AyaInfo) => ({
    loading: AyaInfo.loading,
    categories: AyaInfo.categories,
    defaultSortBy: AyaInfo.defaultSortBy,
    updatedAt: AyaInfo.updated_at,
  })
)
